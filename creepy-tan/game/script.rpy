...
label start:
    ...
    us "Чем мы займёмся сегодня вечером, командир?"

    show mt smile pioneer with dissolve
    
    mt "Пионеры! Коммунистическая партия учит нас бдеть и чтить наследие предков."
    ...
    us "Семён, а Семён, поди сюда."
    me "?"
    "Алиса и Ульяна разговариват с Ольгой в стороне."
    ...
    show dv smile pioneer with dissolve
    dv "Не беспокойся за Ульянку. Они с вожатой сёстры по разуму. Ольга, говорят, была тем еще шкедом совсем недавно." # а ещё у Ульянки под кроватью третий том Капитала лежит
    dv "Похоже, она видит в ней себя, и не может долго на неё злиться."
    ...
    dv "Спасибо что согласился помочь, Сёма-кун. Мы не особо много общались, но боюсь, за эти несколько дней, у тебя могло солжиться неправильное мнение обо мне."
    # Держись козёл за стул, щас как вылезу

    # Я сразу смазал карту будня *gulp-gulp-gulp* плеснувши краски из стакана.

    kr "Что закопался как врытый?"
